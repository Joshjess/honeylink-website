...
export const contactDetails: ContactDetail[] = [
  {
    label: "E-mail",
    value: "info@honeylink.nl",
    href: "mailto:info@honeylink.nl",
    icon: "email",
  },
  {
    label: "Adres",
    value: "Marco Polostraat 275-3, 1056DN Amsterdam",
    icon: "address",
  },
